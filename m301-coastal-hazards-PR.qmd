...
merged_df = pr_df_2020.merge(pr_df_2010[["GISJOIN"]+columns_used], on = "GISJOIN", how = "inner", suffixes=("_2020", "_2010"))
merged_df
...
if "Total_Population" not in merged_df.columns:
    merged_df["Total_Population"] = merged_df[joined_columns].sum(axis=1)

# 3. Create DataFrame for percentage values
pct_df = merged_df[["Total_Population"] + joined_columns].copy()
