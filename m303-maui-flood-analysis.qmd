...
## Introduction
Floods are one of the most destructive and persistent natural hazards, affecting vast populations and resulting in enormous economic losses worldwide. In recent decade, flood occurances have risen, a trend closely linked to human-driven climate change and the warming of the planet [@ceola2022unraveling][@undrr2025garfloods].

Increasing global temperatures and more extreme rainfalls are the main drivers behind the growing frequency and intensity of floods, because a warmer atmosphere accelerates the hydrologic cycle and produces heavier downpours and higher river flows [@chen2023impacts][@rogers2025role]. Recent large-scale studies estimate that climate change accounts for 21% of the observed rise in global flood exposure, while urbanization—especially dense development of people and assets in floodplains—explains up to about 77% of the increase, with urban and low-income communities facing the greatest exposure [@devitt2023flood][@rogers2025role]. Additional research focused on the United States indicates that rapid coastal urban growth is outstripping infrastructure upgrades, creating larger, more densely populated, and more flood-prone settlements, and similar patterns are even more acute in poorer countries where fast development collides with limited capacity to adapt [@swain2020increased][@rentschler2022flood].

**Population density** is typically defined as the number of people living within a given area, such as inhabitants per square kilometer. Scientists estimate this using sources like national censuses and high-resolution gridded population datasets (for example, the Global Human Settlement Layer, WorldPop, or GPWv4), and in some cases supplement these with dynamic information from mobile phone call records or satellite imagery to refine where people are actually located.​
...
folder = r"/Users/ulugbekmedetov/Downloads/2025-07-07-47e9ab"
...
obs_df = pd.read_csv("/Users/ulugbekmedetov/Downloads/maui_rain/maui_rain_gauge_Jan2024.csv")
...
shapefile_zip = "/Users/ulugbekmedetov/Downloads/maui_rain/tl_2023_15_tract.zip"
shapefile_dir = "/Users/ulugbekmedetov/Downloads/maui_rain/tl_2023_15_tract"
```
